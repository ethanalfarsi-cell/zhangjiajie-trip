...
const t = {
  zh: {
    ...
    utilityPhone: "旅行咨询：+86 744 000 0000",
    utilityEmail: "service@example.com",
    navTours: "路线与行程",
    navMoments: "游客瞬间",
    navContact: "联系我们",
    eyebrow: "ZHANGJIAJIE TOURS & TRAVEL",
    headline: "为全球游客规划张家界路线",
    intro: "从天门山、国家森林公园到大峡谷玻璃桥，游客可以按天数、兴趣和体力自由选择路线。",
    start: "开始选择路线",
    contactGuide: "联系导游服务",
    plannerEyebrow: "PLAN",
    heroPanelTitle: "选择你的张家界探险",
  ...
  en: {
    ...
    utilityPhone: "Travel help: +86 744 000 0000",
    utilityEmail: "service@example.com",
    navTours: "Tours & Routes",
    navMoments: "Traveler Moments",
    navContact: "Contact",
    eyebrow: "ZHANGJIAJIE TOURS & TRAVEL",
    ...
    plannerEyebrow: "PLAN",
    heroPanelTitle: "Choose your Zhangjiajie adventure",
  ...
  ko: {
    ...
    utilityPhone: "여행 상담: +86 744 000 0000",
    utilityEmail: "service@example.com",
    navTours: "코스와 일정",
    navMoments: "여행자 순간",
    navContact: "문의",
